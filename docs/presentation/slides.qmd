...
::: { .columns }
::: {.column width="33%"} ![](figures/annual-long-bias.png) :::
::: {.column width="33%"} ![](figures/annual-ls-dn.png) :::
::: {.column width="33%"} ![](figures/annual-ls-rn.png) :::
:::

## Curvas acumuladas — por estratégia
::: { .columns }
::: {.column width="33%"} ![](figures/cum-long-bias.png) :::
::: {.column width="33%"} ![](figures/cum-ls-dn.png) :::
::: {.column width="33%"} ![](figures/cum-ls-rn.png) :::
:::
